...
if($_POST[setid] == $_SESSION[setid])
{
	if(isset($_POST[submit]))
	{
			  ...
			  if(isset($_GET[queid]))
				...
				{
					$sql="INSERT INTO questions( subjectcode,  question, uploads, option1, option2, option3, option4, answer, description, status) VALUES($_POST[subjectid],$_POST[question],$filename,$_POST[optiona],$_POST[optionb],$_POST[optionc],$_POST[optiond],$_POST[answerid],$_POST[description],$_POST[status])";
